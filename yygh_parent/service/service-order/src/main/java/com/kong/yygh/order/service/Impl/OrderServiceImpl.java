...
//        }
    ...
    @Override
    public Map<String, Object> getCountMap(OrderCountQueryVo vo) {
        Map<String, Object> map = new HashMap<>();

        List<OrderCountVo> orderCountVoList
                = baseMapper.selectOrderCount(vo);
        //日期列表
